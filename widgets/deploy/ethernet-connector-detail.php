...
if(mysqli_num_rows($query) > 0) {
	...
	$accessories_query = mysqli_query($conn, "SELECT * FROM accessories WHERE item_category='16' && active_status='1' && delete_status='0' && qty!='0'");
	...
	if(mysqli_num_rows($accessories_query) > 0) {
		...
		echo "<p class='alert alert-danger'>You haven't any Ethernet Connector in Inventory</p>";
	}
