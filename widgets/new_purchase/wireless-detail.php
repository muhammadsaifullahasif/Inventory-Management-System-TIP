...
<input type="hidden" value="" name="item_type">
<!-- <div class='mb-3'>
	<label>Number of Ports:</label>
	<input type="text" class="form-control form-control-border" placeholder="Enter Number of Ports" id="item_type" name="item_type" required>
	<div id="hub_ports_msg"></div>
</div> -->
<div class='mb-3'>
