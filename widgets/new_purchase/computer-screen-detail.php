...
<div class='mb-3'>
	...
	<input type='text' class='form-control form-control-border' placeholder='Enter Screen Dimensions' name='screen_dimension' id='screen_dimension' required>
	<div id="screen_dimension_msg"></div>
</div>
