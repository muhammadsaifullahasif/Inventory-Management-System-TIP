...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			...
			<div class="info"><a href="#" class="d-block"><?php echo display_name($user_id); ?></a></div>
		</div>
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-legacy nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item">
					<a href="new-purchase.php" class="nav-link">
				...
				<li class="nav-item menu-is-opening menu-open">
					...
					<ul class="nav nav-treeview" style="display: block;">
						...
						<li class="nav-item">
							<a href="assets-deployed.php" class="nav-link">
								<i class="far fa-circle nav-icon text-primary"></i>
								<p>All Deployed</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="assets-ready-to-deploy.php" class="nav-link">
								<i class="far fa-circle nav-icon text-success"></i>
								<p>All Ready to Deploy</p>
							</a>
						</li>
						<!-- <li class="nav-item">
							<a href="asset-pending.php" class="nav-link">
								<i class="far fa-circle nav-icon text-warning"></i>
								<p>All Pending</p>
							</a>
						</li> -->
						<li class="nav-item">
							<a href="assets-un-deployed.php" class="nav-link">
								<i class="fas fa-times nav-icon text-danger"></i>
								<p>All Un-deployed</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="assets-faulty.php" class="nav-link">
								<i class="fas fa-times nav-icon text-danger"></i>
								<p>Faulty Assets</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="assets-defect.php" class="nav-link">
								<i class="fas fa-times nav-icon text-danger"></i>
								<p>Defect Assets</p>
							</a>
						</li>
						<!-- <li class="nav-item">
							<a href="asset-archived.php" class="nav-link">
								<i class="fas fa-times nav-icon text-danger"></i>
								<p>All Archived</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="asset-requestable.php" class="nav-link">
								<i class="fas fa-check nav-icon text-primary"></i>
								<p>Requestable</p>
							</a>
						</li> -->
				...
				<li class="nav-item">
					<a href="peoples.php" class="nav-link">
